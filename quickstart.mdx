...
description: "Send a real robot observation to Dreamscale and inspect one action chunk without actuating."
keywords: ["Python quickstart", "dreamscale.connect", "robot integration", "policy prediction"]
---
