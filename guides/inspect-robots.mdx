...
<Note>
  ...
  registry name; it does not close objects you passed in.
</Note>
...
the fraction of steps where the robot held position. A high hold fraction means
the action buffer drained, usually because the round trip exceeded the chunk
horizon. Lowering the command rate lengthens the horizon and can absorb it.
